...
package org.grameen.mobileSurvey.activities;
...
import org.grameen.mobileSurvey.listeners.AdvanceToNextListener;
import org.grameen.mobileSurvey.listeners.FormLoaderListener;
import org.grameen.mobileSurvey.listeners.FormSavedListener;
import org.grameen.mobileSurvey.logic.FormController;
import org.grameen.mobileSurvey.logic.PropertyManager;
import org.grameen.mobileSurvey.preferences.PreferencesActivity;
import org.grameen.mobileSurvey.provider.FormsProviderAPI.FormsColumns;
...
import org.grameen.mobileSurvey.tasks.FormLoaderTask;
import org.grameen.mobileSurvey.tasks.SaveToDiskTask;
import org.grameen.mobileSurvey.utilities.FileUtils;
import org.grameen.mobileSurvey.views.ODKView;
import org.grameen.mobileSurvey.widgets.QuestionWidget;
...
public class FormEntryActivity extends Activity implements AnimationListener, FormLoaderListener,
    ...
    private static final int AUTOSAVE_AFTER_QUESTION = 3 ; //how many questions you must swipe before autosaving.

    public static boolean isShowingDialog=false;           //we need to know if the Progress dialog is showing while the AsyncTask is running
    													   //we cant close a non-showing dialog
	...
	private int questionSinceLastAutosave = -1 ;
    ...
    private void showNextView() {
        ...
        questionSinceLastAutosave = (questionSinceLastAutosave + 1) % AUTOSAVE_AFTER_QUESTION ;
    	Log.d(t, "Question Count: " + questionSinceLastAutosave);

    	// I check if I have to autosave the form
    	if(questionSinceLastAutosave == 0 ){
    		Log.d(t, "I have to autosave this survey, because it reach an autosave number");
     ...
     */
    private boolean saveDataToDisk(boolean exit, boolean complete, String updatedSaveName,boolean showDialog) {
        // save current answer
    ...
    public void savingComplete(int saveStatus) {
	    if(FormEntryActivity.isShowingDialog){
